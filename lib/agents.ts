...
- MEASURE 2.5: AI system effectiveness in minimising negative impacts is evaluated (equity, bias, privacy).
- MEASURE 2.6: AI system performance and risk are evaluated for known failure modes and edge cases.
...
- Principle 2 Identifying Purposes: Identify purposes for personal information collection before or at time of collection.
...
- Principle 7 Safeguards: Protect personal information with security safeguards appropriate to sensitivity.
...
- Data breach notification required to OPC and affected individuals when real risk of significant harm.
- Privacy Impact Assessments recommended before deploying AI systems handling personal information.
`;
...
In your rationale (1 sentence each), cite specific NIST AI RMF sub-categories (e.g. GOVERN 1.2, MEASURE 2.5),
ISO 42001 clauses (e.g. ISO 42001 Clause 8.4, Annex A.8.3), or PIPEDA principles
(e.g. PIPEDA Principle 3 Consent) where directly relevant.
...
Output ONLY valid JSON in this exact format (no markdown, no extra text):
{
  "scores": [
    ...
    {"id": "data_privacy", "score": 7.0, "rationale": "one sentence"},
    {"id": "transparency", "score": 5.5, "rationale": "one sentence"},
    {"id": "robustness", "score": 3.0, "rationale": "one sentence"},
    {"id": "non_discrimination", "score": 6.0, "rationale": "one sentence"},
    {"id": "accountability", "score": 4.0, "rationale": "one sentence"}
  ]
}`;
...
Score each of the 6 criteria now using the rubric provided.`;
...
4. A confidence score (0-100) reflecting how complete and reliable the assessment is.
...
Cite specific framework clauses in recommendations. Examples:
...
Keep each item concise (max 20 words). Max 4 red flags, 5 immediate actions, 5 longer-term actions.
